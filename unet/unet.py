...
from keras.layers import Input, concatenate, Conv2D, Conv2D, MaxPooling2D, UpSampling2D, Cropping2D, ZeroPadding2D, Dropout, Cropping2D, BatchNormalization, Activation
